		...
		<div class="jumbotron" style="background-color:">
			...
			<form action="newCategory"class="form-horizontal"  method="post"   role="form" name="category">
				...
				<div style="color: #27A4F7" class="form-group">
					...
					<input class="form-control" placeholder="Enter the name of the category" type="text"  id="name" name="category_name" value="${category.category_name}">
				</div>
				<div style="color: #27A4F7" class="form-group">
					<label for="text">Description about category:</label> 
					<input name="category_Description" class="form-control" placeholder="Description" type="text"  id="description"  value="${category.category_Description}" >
				</div>
