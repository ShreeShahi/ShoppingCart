...
<div class="row" style="margin-top:60px">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
    	<form role="form" action="newCategory" method="post">
            ...
            <input class="form-control input-lg" type="text" name='category_name' placeholder="Categoryname"/>     
          </div>
          <div class="form-group">
           
            <input class="form-control input-lg" type="text" name='category_Description' placeholder="Description"/>     
          </div>
